...
public class GrandSlam {
    ...
    public static void main(String[] args) {
        ...
        switch(opcion){
            case 1:System.out.println("Desea Crear Participantes Manualmente? s/n");
                entrada.nextLine();
                String letra=entrada.nextLine();
                nuevoTorneo.crearParticipantes(letra);
                break;
            case 2: nuevoTorneo.armarPrimeraRonda();
                break;
            case 3:System.out.println("Ingrese el Nivel de la Fase");
                ...
                break;
            case 4: System.out.println("Ingrese el Nivel de la Fase");
                System.out.println("1: Final");
                System.out.println("2: Semi Final");
                System.out.println("4: Cuartos de Final");
                System.out.println("8: Octavos de Final");
                ...
                break;
            case 5: nuevoTorneo.mostrarTorneo();
                break;
            case 6:System.out.println("Elija el nimero del 1 al "+ (participantes-1)); 
                int o = entrada.nextInt();
                nuevoTorneo.busquedaPartido(o);
                break;
            case 7: System.out.println("Saliendo del Torneo");
                break;
            default: System.out.println("Opcion elegida invalida, ingrese una correcta");
                break;
        }
        }while (opcion != 7);
